...
En el gráfico a continuación se observa que los años de mayor registro fueron el 2010 y 2016, y el registro más bajo 2020. Se puede observar una tendencia descendiente, a diferencia de la curva del total en PBA que a partir del 2021 los registros generan un cresimiento abrupto.
...
defunciones_maternas_2009_2021 %>%
  ...
  geom_line(aes(color= region_sanitaria))+
  geom_point()
